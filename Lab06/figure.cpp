...
CMyLine::CMyLine(POINT& ptS, POINT & ptE, LOGPEN& logPen, COLORREF& color)
{
	m_type = DRAW_MODE_LINE;
	m_ptS = ptS;
	m_ptE = ptE;
	m_logPen = logPen;
	m_color = color;
