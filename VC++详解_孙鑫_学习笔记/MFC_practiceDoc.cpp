...
// MFC_practiceDoc.cpp: CMFCpracticeDoc 类的实现
//
...
// CMFCpracticeDoc 构造/析构

CMFCpracticeDoc::CMFCpracticeDoc() noexcept
{
	// TODO: 在此添加一次性构造代码
...
// 缩略图的支持
void CMFCpracticeDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void CMFCpracticeDoc::InitializeSearchContent()
{
...
void CMFCpracticeDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
